                        ...
                        <div class="panel-body">
                            <div class="col-md-12"  id="conteudo">
                                <div class="panel panel-default">
                                    ...
                                    <input type='hidden' value='{{noticia.getId()}}' name='id'>
                                        <div class="row">
                                            <div class="form-group col-sm-12">
                                                <p><strong>Data de Criação:</strong> {{noticia.getData_cadastro()}}</p>
                                                <p><strong>Data da Última Atualização:</strong> {{noticia.getData_cadastro()}}</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-sm-12">
                                                <label for ="Titulo">Título <span class="error">(*)<span></label>
                                                <input type="text" value="{{noticia.getTitulo()}}" width='100%' class= "form-control">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-sm-12">
                                                <label for ="Texto">{{noticia.getTexto()}}</label>
                                                <textarea class= "form-control">{{noticia.getTexto()}}</textarea>
                                            </div>
                                        </div>
                                    </div>{#/.panel-body#}
                                </div>{#/.panel#}
